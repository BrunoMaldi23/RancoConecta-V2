...
abstract interface class FavoritesRepository {
  ...
  Future<Result<bool>> isFavorite(String businessId);
  Future<Result<void>> addFavorite(String businessId);
  Future<Result<void>> removeFavorite(String businessId);
}
...
businesses(id, owner_id, business_type, name, slug, description, phone, whatsapp, email, website, verification_status,
business_services(description, price_from, subcategory_id, subcategories(id, category_id, name, slug, description, icon_key)),
business_coverage(location_id, locations(id, commune_id, name, slug)),
business_hours(day_of_week, open_time, close_time, is_closed),
business_media(media_type, storage_path, sort_order))
''';
    ...
    try {
      ...
      for (final row in rows) {
        ...
        if (business is Map<String, dynamic>) {
          businesses.add(BusinessDto.fromJson(business).toDomain());
        }
      }
  ...
  @override
  Future<Result<bool>> isFavorite(String businessId) async {
    final client = _client;
    final userId = _userId;
    if (client == null || userId == null) {
  ...
  @override
  Future<Result<void>> addFavorite(String businessId) async {
    final client = _client;
    final userId = _userId;
    if (client == null || userId == null) {
  ...
  @override
  Future<Result<void>> removeFavorite(String businessId) async {
    final client = _client;
    final userId = _userId;
    if (client == null || userId == null) {
      return const Failure(AppFailure(
